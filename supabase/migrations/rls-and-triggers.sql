...
-- NOTE: this section is superseded by 0004_fix_handle_new_user_trigger.sql
-- (this original version silently failed when batched with the RLS
-- policies below — run 0004 separately for the working trigger)
-- ============================================================
